...
server_app <- function(input, output, session) {
 ...
 url1 <-"https://raw.github.com/AmandaRT18/Cell.Naming/blob/main/data/Kimmey_5hr_stim.csv"
 ...
 url2 <- "https://raw.github.com/AmandaRT18/Cell.Naming/blob/main/data/Dusoswa_OMIP_54_markers.csv"
 ...
 url3 <- "https://raw.github.com/AmandaRT18/Cell.Naming/blob/main/data/Lee_AML_cell_types_markers.csv"
